...
for i in range(ITER_TIMES):
    ...
    with tf.device('/gpu:0'):
        learning_rate, loss, accuracy = sess.run([learning_rate_current,total_loss_64x64, accuracy_64x64],feed_dict={x: images_input, y: lable_input, qp: qp_input,global_step: feed_step})
